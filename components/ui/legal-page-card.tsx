// components/ui/legal-page-card.tsx
"use client";
...
/**
 * Props for the LegalPageCard component.
 * Used for all legal documents across the site.
 */
interface LegalPageCardProps {
  ...
  summary?: string;
  /**
   * Accent color that influences heading colours, badge, icon, and borders.
   * Can be one of: "primary", "foreground", "slate", "navy", "gold", "emerald".
   * Defaults to "primary".
   */
  headingColor?: "primary" | "foreground" | "slate" | "navy" | "gold" | "emerald";
  /** Alias for headingColor – kept for backward compatibility */
  accentColor?: "primary" | "foreground" | "slate" | "navy" | "gold" | "emerald";
...
/**
 * Maps headingColor / accentColor to Tailwind classes for:
...
/**
 * Reusable page template for legal documents.
 * Wraps content in a shadcn/ui Card, applies the chosen accent colour,
...
export function LegalPageCard({
  ...
  // Prefer headingColor, fallback to accentColor, then default to "primary"
  const effectiveColor = headingColor || accentColor || "primary";
  const color = colorMap[effectiveColor as keyof typeof colorMap] || colorMap.primary;
